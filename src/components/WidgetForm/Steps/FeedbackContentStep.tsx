import { ArrowLeft, Camera, Rocket, TwitterLogo } from "phosphor-react";
...
const [comment, setComment] = useState('');
    ...
    return (
        <> 
         <header>
            <button
             type="button" className="top-5 left-5 absolute text-zinc-400 hover:text-zinc-100 borderRadius-"
         ...
         <form onSubmit={handleSubmitFeedback} className="my-4 w-full">
             <textarea
                ...
                onChange={event => setComment(event.target.value)} //traz o texto do textarea
             />
             ...
             <footer className="flex gap-2 mt-2">
                ...
                /> 
                 <button
                    ...
                    focus:ring-offset-zinc-900 focus:ring-brand-500 transiction-colors disabled:opacity-50 disabled:hover:bg-brand-500"
                 >
                     Enviar Feedback 
                 </button>
             </footer>
